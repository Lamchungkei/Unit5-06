...
# Created for: ICS3U
# This program displays taking a unicode character in a string and returns its hexidecimal equivalent

def hexadecimal_converter(user_input):
    # creates a dictionary of hexidecimal values assigned to their proper unicode character equivalents
...
# input
user_string = raw_input('Enter a letter or a word: ')
